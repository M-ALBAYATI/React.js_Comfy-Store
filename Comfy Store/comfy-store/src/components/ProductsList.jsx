        ...
        return (
          ...
          >
            <img
              src={image}
              alt={title}
              className="h-24 w-24 rounded-lg ms:h-32 sm:w-32 object-cover group-hover:scale-105 transition duration-300"
            />
            ...
            <p className="font-medium ml0 sm:ml-auto text-lg">
              {dollarsAmount}
            </p>
          </Link>
        )
